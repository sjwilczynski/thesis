...
Maybe it should be put in the beginning of section3 for example to introduce bias-variance tradeoff and cross validation and use this notions freely in the model description, e.g. b-v tradeoff in Random forest. Aslo it is good to add it in regularization of LR.
