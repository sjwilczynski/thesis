...
It is also worth noticing that the choice of $L_2$ norm was motivated by interpretation of $M$. Discarding $M$ allows us to select norm almost arbitrarily, depending only on the final properties that we want our model to have. Therefore, one can choose $L_1$ norm in order to enforce sparsity. 
